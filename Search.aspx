<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="WPLProject.Search" %>
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar" class="navbar navbar-expand-lg navbar-light">
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        <a href="Search.aspx" class="active"><i class="fas fa-search"></i>Search</a>
                    </li>
                    <li>
                                ...
                                <div class="row my-5 w-100">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="SearchInput" CssClass="form-control my-3" runat="server"></asp:TextBox>
                                            <asp:Button ID="SearchBtn" CssClass="btn" runat="server" Text="Search" OnClick="SearchBtn_Click" />
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <asp:GridView
                                            ...
                                            EmptyDataText="No Results found. Please add a keyword to search"
                                            AllowPaging="True"
                                            >
                                            <Columns>
                                        ...
                                        <asp:SqlDataSource
                                            ID="SqlDataSource1"
                                            runat="server"
                                            ConnectionString="<%$ ConnectionStrings:db_PaperConnectionString %>"></asp:SqlDataSource>
                                    </div>
                                </div>
                            </div>
                            <div class="container">
